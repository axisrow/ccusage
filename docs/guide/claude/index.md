...
For Codex, OpenCode, Amp, Droid, Codebuff, Hermes Agent, pi-agent, Goose, ZCode (Z.ai), OpenClaw, Kilo, Kimi, Qwen, GitHub Copilot CLI, and Gemini CLI data locations, use the source-specific environment variables listed in [Environment Variables](/guide/environment-variables).
